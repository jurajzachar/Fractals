...
public class FractalSphere extends JFrame{
/**
	 * 
	 */
...
private FractalSphereJpanel drawSpace;
private JPanel mainJPanel, controlJPanel;

 // set up GUI
public FractalSphere(){
 super( "Fractal" );
...
FractalSphere.this, "Choose a color", color );
...
decreaseLevelJButton.addActionListener(
		...
		// modify level if possible
		 ...
		 drawSpace = new FractalSphereJpanel( 0 );
...
public static void main( String args[] ){
	FractalSphere demo = new FractalSphere();
